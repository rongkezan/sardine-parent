...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        File file = new File("sardine-mybatis-plus");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/swan?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai");
